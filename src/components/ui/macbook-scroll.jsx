...
export const MacbookScroll = ({ src, showGradient, title, badge }) => {
  ...
  return (
    <div
      ref={ref}
      className="max-xsm:min-h-[120vh] xsm:min-h-[150vh] sm:min-h-[170vh] md:min-h-[180vh] lg:min-h-[205vh] xl:min-h-[232vh] 2xl:min-h-[272vh] flex flex-col items-center py-0 md:py-20 xl:py-40 2xl:py-96 justify-start flex-shrink-0 [perspective:800px] transform   scale-[0.40] xsm:scale-[0.55] sm:scale-[0.75] md:scale-[0.95] lg:scale-100 xl:scale-[1.15] 2xl:scale-[1.30] duration-300"
    >
      <motion.h2
        style={{
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[35rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[35rem] bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
