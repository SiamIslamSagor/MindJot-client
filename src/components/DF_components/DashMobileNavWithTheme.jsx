...
//         className="flex items-center justify-start gap-6 p-4 w-screen backdrop-blur-[80px] bg-white dark:bg-black  shadow-2xl relative"
//         /*  className="flex items-center justify-start gap-6 p-4 w-screen backdrop-blur-[80px] bg-white  shadow-2xl relative" */
//       >
...
//             //   currentPathname === link.path
//             //     ? `${mobileActiveLinkStyle}
//             //     dark:after:bg-gradient-to-t from-whiteColor dark:after:duration-300 dark:act_lnk_light dark:after:pointer-events-none dark:after:content-[''] dark:after:absolute dark:after:w-[65px] dark:after:h-[75px] dark:after:bottom-2 dark:after:opacity-[.35]
//             //     `
//             //     : `${mobileNormalLinkStyle} dark:after:bg-gradient-to-t from-whiteColor dark:nrm_lnk_light dark:after:pointer-events-none dark:after:content-[''] dark:after:absolute dark:after:w-[20px] dark:after:h-0 dark:after:bottom-2 dark:after:opacity-[.15]`
//             // }`}
//             href={`${link.path}`}
//             key={link.heading}
//           >
